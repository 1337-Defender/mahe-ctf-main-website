  ...
  misc: [
    {
      ...
      description: "Solve this crossword puzzle where the clues are regular expressions.",
      difficulty: "medium",
      points: 200,
      category: "misc",
      solved: true,
    ...
    },
    {
      ...
      description: "This program checks if the input is the correct flag. Can you reverse engineer it?",
      difficulty: "hard",
      points: 350,
      category: "misc",
      solved: false,

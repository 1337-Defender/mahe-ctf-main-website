...
import {getChallenges, getTeamMemberInfo} from "@/lib/actions";
...
export default async function CategoryPage({ params }: { params: { category: string } }) {
  ...
  const teamMemberData = await getTeamMemberInfo();
  ...
  return (
    <div className="container py-6 space-y-6">
      ...
      <ChallengeList challenges={challenges} category={category} teamMemberData={teamMemberData} />
    </div>
  )
}
